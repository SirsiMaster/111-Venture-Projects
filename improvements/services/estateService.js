...
const estateServiceInstance = new EstateService();

// Alias methods for compatibility
estateServiceInstance.getAllEstates = estateServiceInstance.getEstates.bind(estateServiceInstance);

// Auto-initialize
estateServiceInstance.initialize().catch(console.error);

// Make globally available
window.EstateService = estateServiceInstance;

export default estateServiceInstance;
